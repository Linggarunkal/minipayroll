...
Public Class menuKaryawan
    ...
    Private Sub ExitToolsStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ExitToolStripMenuItem.Click
        If MsgBox("Are Sure Exit Application ?", MsgBoxStyle.YesNo, "Exit Application") = MsgBoxResult.Yes Then
            Application.Exit()
        End If
    End Sub
    ...
    Private Sub PrintPreviewToolStripButton_Click(sender As Object, e As EventArgs) Handles PrintPreviewToolStripButton.Click
        reportKaryawan.MdiParent = Me
        reportKaryawan.WindowState = FormWindowState.Normal
        reportKaryawan.Show()
    End Sub
End Class
